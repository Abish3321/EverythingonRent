    ...
    <div class="container" style="padding-top: 55px;">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
				...
				<div class="thumbnail">
					<img src="uploads/<?php echo $row['profile_pic']; ?>" class="img-responsive" width="300" alt="<?php echo $row['profile_pic']?>"  alt="..." >
					<div class="caption">
                ...
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="uploads/<?php echo $row['item_img']; ?>" class="img-responsive" width="300" alt="<?php echo $row['item_img']?>"></td>
                        </tr>
                        <tr>
