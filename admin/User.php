      ...
      <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
          ...
          <div class="collapse navbar-collapse navbar-ex1-collapse">
              <ul class="nav navbar-nav side-nav">
                  ...
                  <li class="active"><a href="User.php"><i class="glyphicon glyphicon-user"></i>&nbsp;Users</a></li>
      ...
      <div class="page-wrapper">
        <div class="container-fluid">
            <div class="row" id="main">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6 coledit">
                    <a href="AddUser.php"><button type="button" class="btn btn-lg  btnedit">Add User
                            details</button></a>
                    </a>
                    <!--end::Button-->
                </div>
              ...
              <table class="table table-bordered table-striped">
                <thead>
                  <tr>
                    ...
                    <th>Phone No.</th>
                    <th>Address</th>
                    <th>Verification Proof Files</th>
                    <th>Actions</th>
                  </tr>
                </thead>
                <tbody>
